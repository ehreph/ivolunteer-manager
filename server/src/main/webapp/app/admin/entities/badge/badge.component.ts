...
export class BadgeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.badgeService
      ...
      .subscribe(
        (res: HttpResponse<IBadge[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInBadges(): void {
    this.eventSubscriber = this.eventManager.subscribe('badgeListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IBadge[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
