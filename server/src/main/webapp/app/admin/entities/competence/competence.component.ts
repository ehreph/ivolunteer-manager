...
export class CompetenceComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.competenceService
      ...
      .subscribe(
        (res: HttpResponse<ICompetence[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInCompetences(): void {
    this.eventSubscriber = this.eventManager.subscribe('competenceListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ICompetence[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
