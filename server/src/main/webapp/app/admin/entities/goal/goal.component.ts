...
export class GoalComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.goalService
      ...
      .subscribe(
        (res: HttpResponse<IGoal[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInGoals(): void {
    this.eventSubscriber = this.eventManager.subscribe('goalListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IGoal[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
