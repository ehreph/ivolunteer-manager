...
export class InstitutionComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.institutionService
      ...
      .subscribe(
        (res: HttpResponse<IInstitution[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInInstitutions(): void {
    this.eventSubscriber = this.eventManager.subscribe('institutionListModification', () => this.loadPage());
  }
