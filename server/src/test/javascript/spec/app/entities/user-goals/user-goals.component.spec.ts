...
import { UserGoalsComponent } from 'app/entities/user-goals/user-goals.component';
...
describe('Component Tests', () => {
  describe('UserGoals Management Component', () => {
    let comp: UserGoalsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserGoalsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userGoals && comp.userGoals[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
